...
public class PartitionManagerTest {
    ...
    public void shouldLock() {
        boolean locked = partitionManager.lockPartition("test", "sales-order-placed", "0", "node-1", 100, TimeUnit.MILLISECONDS);
        Assert.assertTrue(locked);
    }

    @Test
    public void shouldNotLockAlreadyLocked() {
        boolean locked1 = partitionManager.lockPartition("test", "sales-order-placed", "0", "node-1", 100, TimeUnit.MILLISECONDS);
        Assert.assertTrue(locked1);

        boolean locked2 = partitionManager.lockPartition("test", "sales-order-placed", "0", "node-1", 100, TimeUnit.MILLISECONDS);
        Assert.assertFalse(locked2);
    }

    @Test
    public void shouldLockIndependentConsumers() {
        boolean locked1 = partitionManager.lockPartition("test1", "sales-order-placed", "0", "node-1", 100, TimeUnit.MILLISECONDS);
        Assert.assertTrue(locked1);

        boolean locked2 = partitionManager.lockPartition("test2", "sales-order-placed", "0", "node-1", 100, TimeUnit.MILLISECONDS);
    ...
    public void shouldLockIndependentEvents() {
        ...
        boolean locked2 = partitionManager.lockPartition("test", "address-changed", "0", "node-1", 100, TimeUnit.MILLISECONDS);
        Assert.assertTrue(locked2);
    }
    ...
    public void shouldLockIndependentPartitions() {
        ...
        boolean locked2 = partitionManager.lockPartition("test2", "sales-order-placed", "1", "node-1", 100, TimeUnit.MILLISECONDS);
        Assert.assertTrue(locked2);
    }
    ...
    public void shouldExpireLocks() throws InterruptedException {
        ...
        boolean locked2 = partitionManager.lockPartition("test", "sales-order-placed", "0", "node-2", 100, TimeUnit.MILLISECONDS);
        Assert.assertTrue(locked2);
    }

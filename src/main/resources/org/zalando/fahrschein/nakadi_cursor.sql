...
CREATE OR REPLACE FUNCTION nakadi_cursor_partition_lock(p_consumer_name text, p_event_name text, p_partition text, p_locked_by text, p_lock_timeout bigint) RETURNS INT AS
$$
DECLARE
